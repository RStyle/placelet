        <article id="impressum" class="mainarticles bottom_border_green">
			...
			<div style="float: right; width: 50%">
				...
				<p>
					<a href="http://validator.w3.org/check?uri=http%3A%2F%2Fplacelet.de"
						style="text-decoration: none;">
						<img src="http://www.w3.org/html/logo/badge/html5-badge-h-solo.png" width="63" height="64" alt="HTML5 ist valide">
					</a>&nbsp;
					<a href="http://jigsaw.w3.org/css-validator/validator?uri=placelet.de"
						style="text-decoration: none;">
		...
		<article id="disclaimer" class="mainarticles bottom_border_blue">
			...
			<p>Unser Angebot enthält Links zu externen Webseiten Dritter, auf deren Inhalte wir keinen Einfluss haben. Deshalb können wir für diese fremden Inhalte auch keine Gewähr übernehmen. Für die Inhalte der verlinkten Seiten ist stets der jeweilige Anbieter oder Betreiber der Seiten verantwort-lich. Die verlinkten Seiten wurden zum Zeitpunkt der Verlinkung auf mögliche Rechtsverstöße überprüft. Rechtswidrige Inhalte waren zum Zeit-punkt der Verlinkung nicht erkennbar. Eine permanente inhaltliche Kontrolle der verlinkten Seiten ist jedoch ohne konkrete Anhaltspunkte einer Rechtsverletzung nicht zumutbar. Bei Bekanntwerden von Rechtsverletzungen werden wir derartige Links umgehend entfernen.</p>
			<h4>Urheberrecht</h4>
			...
			Der Nutzung von im Rahmen der Impressumspflicht veröffentlichten Kontaktdaten durch Dritte zur Übersendung von nicht ausdrücklich angefor-derter Werbung und Informationsmaterialien wird hiermit ausdrücklich widersprochen. Die Betreiber der Seiten behalten sich ausdrücklich rechtli-che Schritte im Falle der unverlangten Zusendung von Werbeinformationen, etwa durch Spam-Mails, vor.</p>
			<p>Quellverweis: Disclaimer eRecht24</p>
		</article>
		<aside id="junior" style="display: none;">
			<h1>JUNIOR</h1>
