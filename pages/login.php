...
if($checklogin == false){
	...
	echo '
	    <form name="registerbr" action="'.$_SERVER['PHP_SELF'].'" method="POST">
              ...
              <input type="text" name="reg_br" id="reg_br" class="input_text" size="20" maxlength="10" placeholder="Armband ID" value="'; if(isset($_GET["registerbr"])) {echo $_GET["registerbr"];}// else {echo "Armband ID";}
		      echo'">
