...
?>
				<div style="width: 100%; overflow: auto;">
					<div style="width: 70%; float: left;">
						<a href="start?&picid=<?php echo $stats[$i][$displayed_picnr]['picid']; ?>&last_pic=last&delete_pic=true" class="delete_button float_right delete_bild" style="margin-top: 2em;" title="Bild löschen/melden" onclick="confirmDelete('das Bild', this); return false;">X</a>
...
?>
						...
						<p class="pic-desc">
							...
							<br><br>
							<span class="pseudo_link toggle_comments" id="toggle_comment<?php echo $i;?>" onClick="show_comments(this);"  data-counts="<?php echo count($stats[$i][$displayed_picnr])-11; ?>">Kommentare zeigen (<?php echo count($stats[$i][$displayed_picnr])-11; ?>)</span>
						</p>
					</div>
