...
?>
					...
					<p class="pic-desc">
						...
						<br><br>
						<span class="pseudo_link toggle_comments" id="toggle_comment<?php echo $i;?>" onClick="show_comments(this);" data-counts="<?php echo count($stats[$i])-11 ?>">Kommentare zeigen (<?php echo count($stats[$i])-11; ?>)</span>
					</p>
